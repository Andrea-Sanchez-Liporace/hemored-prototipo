...
**Mis turnos**
- *Usuario:* consultás turnos pasados y futuros con su estado, el estado de tus formularios pre-donación, cancelás hasta 2 horas antes, o cambiás el turno hasta 24 horas antes. Ese margen de 24hs existe para darle tiempo al hospital de confirmar o rechazar el cambio antes de que llegue la fecha pactada. Después de ese límite, se muestran los datos de contacto del hospital.
