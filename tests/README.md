...
**`sidebar-mobile.spec.js`** — menú lateral (sidebar) de Donante en mobile/tablet, agregado 2026-09-23 tras una auditoría de responsive pedida por la usuaria. El sidebar fijo (240px) recién colapsaba a menú hamburguesa por debajo de los 768px — en tablet (820px) se mostraba completo y apretaba el contenido, sin forma de ocultarlo. El breakpoint pasó a 1024px y se agregó un botón X para cerrar el menú (antes solo se podía tocar afuera, sin ningún control visible):
